...
export class Position implements ValueObject {
    ...
    /** All rows */
    private static readonly row1 = Set.of(Position.a1, Position.a2, Position.a3, Position.a4, Position.a5, Position.a6, Position.a7, Position.a8, Position.a9)
    private static readonly row2 = Set.of(Position.b1, Position.b2, Position.b3, Position.b4, Position.b5, Position.b6, Position.b7, Position.b8, Position.b9)
    private static readonly row3 = Set.of(Position.c1, Position.c2, Position.c3, Position.c4, Position.c5, Position.c6, Position.c7, Position.c8, Position.c9)

    private static readonly row4 = Set.of(Position.d1, Position.d2, Position.d3, Position.d4, Position.d5, Position.d6, Position.d7, Position.d8, Position.d9)
    private static readonly row5 = Set.of(Position.e1, Position.e2, Position.e3, Position.e4, Position.e5, Position.e6, Position.e7, Position.e8, Position.e9)
    private static readonly row6 = Set.of(Position.f1, Position.f2, Position.f3, Position.f4, Position.f5, Position.f6, Position.f7, Position.f8, Position.f9)

    private static readonly row7 = Set.of(Position.g1, Position.g2, Position.g3, Position.g4, Position.g5, Position.g6, Position.g7, Position.g8, Position.g9)
    ...
    private static readonly col2 = Set.of(Position.a2, Position.b2, Position.c2, Position.d2, Position.e2, Position.f2, Position.g2, Position.h2, Position.i2)
    private static readonly col3 = Set.of(Position.a3, Position.b3, Position.c3, Position.d3, Position.e3, Position.f3, Position.g3, Position.h3, Position.i3)

    private static readonly col4 = Set.of(Position.a4, Position.b4, Position.c4, Position.d4, Position.e4, Position.f4, Position.g4, Position.h4, Position.i4)
    private static readonly col5 = Set.of(Position.a5, Position.b5, Position.c5, Position.d5, Position.e5, Position.f5, Position.g5, Position.h5, Position.i5)
    private static readonly col6 = Set.of(Position.a6, Position.b6, Position.c6, Position.d6, Position.e6, Position.f6, Position.g6, Position.h6, Position.i6)

    private static readonly col7 = Set.of(Position.a7, Position.b7, Position.c7, Position.d7, Position.e7, Position.f7, Position.g7, Position.h7, Position.i7)
    ...
    private static readonly sML = Set.of(Position.d1, Position.d2, Position.d3, Position.e1, Position.e2, Position.e3, Position.f1, Position.f2, Position.f3)
    private static readonly sMM = Set.of(Position.d4, Position.d5, Position.d6, Position.e4, Position.e5, Position.e6, Position.f4, Position.f5, Position.f6)
    private static readonly sMR = Set.of(Position.d7, Position.d8, Position.d9, Position.e7, Position.e8, Position.e9, Position.f7, Position.f8, Position.f9)

    private static readonly sBL = Set.of(Position.g1, Position.g2, Position.g3, Position.h1, Position.h2, Position.h3, Position.i1, Position.i2, Position.i3)
    ...
    sameSquare(include: boolean = false): Set<Position> {
    ...
    peers(): Set<Position> {
        return Set.union<Position>([
            this.sameColumn(true),
            this.sameRow(true),
            this.sameSquare(true)
        ]).remove(this)
    }
